...
class bme280:
	def __init__( self, i2c, addr ):
		...
		self.bme280 = self.i2c.setup( self.addr )

	def setup(self):
		self.i2c.writeReg8( self.bme280, 0xf2,0x01 )
		self.i2c.writeReg8( self.bme280, 0xf4,0x27 )
		self.i2c.writeReg8( self.bme280, 0xf5,0xa0 )
	...
	def set_calib(self):
		...
		for i in range ( 0x88, 0x88 + 24 ):
			buf.append( self.i2c.readReg8( self.bme280, i ) )
		buf.append( self.i2c.readReg8( self.bme280, 0xA1 ) )
	...
	def get_value( self ):
		...
		i = 0
		while ( i < 8 ):
			data.append( self.i2c.readReg8( self.bme280, 0xf7 + i ) )
			i = i + 1
